...
----------------------------------------|----------------|-----------------------
[Jupyter](Jupyter/jupyter_on_bianca.md)         |Python          |![Jupyter on Bianca](../../../software/img/jupyter_bianca.png)
[RStudio](RStudio/rstudio_on_bianca.md)         |R               |![RStudio on Bianca](../../../software/img/rstudio_in_action_480_x_270.png)
:no_entry: [VSCode](VS_Code/vscode_on_bianca.md)|General-purpose |Impossible
[VSCodium](VS_Codium/vscodium_on_bianca.md)       |General-purpose |![VSCodium running on Bianca](../../../software/img/vscodium_on_bianca_480_x_270.png)
[MATLAB](MATLAB/index.md)                     | Matlab         | Not yet!
