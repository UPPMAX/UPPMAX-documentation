...
!!! warning "VSCode fails, use VSCodium instead"
    ...
    Instead, go to the page [Using VSCodium on Bianca](../VS_Codium/vscodium_on_bianca.md)

## Introduction

There are multiple [IDEs on Bianca](../ides_on_bianca.md),
among other [VSCodium](../VS_Codium/index.md).
Here we discuss that running [VSCode](index.md)
...
![In VSCode, install the VSCode 'Remote Tunnels' plugin](../../../../software/img/vscode_remote_tunnels_before_install.png)

![In VSCode, installed the VSCode 'Remote Tunnels' plugin](../../../../software/img/vscode_remote_tunnels_after_install.png)
...
![In VSCode, connect to Bianca](../../../../software/img/vscode_add_new_remote.png)
