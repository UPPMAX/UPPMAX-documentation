...
# Using the MATLAB IDE on Pelle
 ...
 ![MATLAB IDE on Pelle](../../../../software/img/matlab_on_pelle_via_website.png)

## Introduction

[MATLAB](index.md) is an [IDE](../ides.md)
specialised for the [MATLAB](index.md) programming language
...
- `[naiss_project_id]` is an [UPPMAX project code](../../../../getting_started/project.md).
  Use [`projinfo`](../../../../software/projinfo.md) to see which
