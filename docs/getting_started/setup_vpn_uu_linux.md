...
- [Procedure](#procedure)
- [Old procedure](#old-procedure): still works, but will become obsolete
...
(requires login),
go the section 'Download for Linux'
and download the binary for your Linux distribution.

## Old procedure

This procedure this work, but will become obsolete
