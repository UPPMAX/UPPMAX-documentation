...
- Linux/MacOS: To copy data to/from Pelle, you can use [`scp`](../Cluster_User_Guide/File_Transfer/Tools/scp.md)
...
!!! see also
    ...
    - [Pelle file transfer using scp](../Cluster_User_Guide/File_Transfer/Pelle/pelle_file_transfer_using_scp.md)
