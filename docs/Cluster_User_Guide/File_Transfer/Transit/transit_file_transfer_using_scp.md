...
Data transfer to/from [Transit](index.md) using [`scp`](../Tools/scp.md)
...
???- question "What is Transit?"
    ...
    See [the page about Transit](index.md) for more detailed information.
...
One **cannot** transfer files to/from Transit using [`scp`](../Tools/scp.md):
[`scp`](../Tools/scp.md) is not considered 'secure' anymore:
instead it is considered an outdated protocol.

The program [`scp`](../Tools/scp.md) allows you to transfer files to/from Transit using SCP,
