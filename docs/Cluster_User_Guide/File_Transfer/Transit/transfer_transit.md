...
There are multiple ways to transfer files to/from [Transit](index.md):
...
[Transit](index.md) is used as a stepping-stone to
[transfer files to Bianca using rsync](../Bianca/bianca_file_transfer_using_rsync.md).
