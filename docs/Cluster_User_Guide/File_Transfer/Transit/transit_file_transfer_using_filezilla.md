...
Here it is shown how to transfer files using a graphical tool called [FileZilla](../Tools/filezilla.md).

???- question "What is Transit?"

    See [the page about the UPPMAX Transit server](index.md).
...
- Bianca file transfer using Transit](../cluster_guides/bianca_file_transfer_using_transit.md)
