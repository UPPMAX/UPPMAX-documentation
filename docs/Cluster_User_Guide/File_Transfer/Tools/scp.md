...
-----------------|---------------------------------------------------------------------------
Local and Bianca |Does not work, see [Bianca file transfer](../Bianca/index.md)
Local and Pelle  |[File transfer to/from Pelle using `scp`](../Pelle/pelle_file_transfer_using_scp.md)
