...
Data transfer to/from Pelle using [Transit](../../Transit/index.md)
is one of the ways ways to transfer files to/from Pelle

???- question "What is Transit?"

    See [the page about the UPPMAX Transit server](../../Transit/index.md).

???- question "What are the other ways?"

    See [the other ways to transfer data to/from Pelle](../index.md)

This page assumes your files are 'posted' to Transit.
[Transit is a service, not a file server](../../Transit/index.md).

???- question "How to transfer files to/from Transit?"

    See [how to transfer files to/from Transit](../../Transit/transfer_transit.md)

To transfer files between Pelle and Transit can be done in multiple ways too:

- [Using SCP](pelle_file_transfer_using_transit_scp.md)
- [Using SFTP](pelle_file_transfer_using_transit_sftp.md)
