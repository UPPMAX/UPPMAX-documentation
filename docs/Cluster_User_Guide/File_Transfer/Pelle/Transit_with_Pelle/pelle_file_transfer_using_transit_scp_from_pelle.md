...
There are multiple ways to [transfer data to/from Pelle](../index.md).

One can transfer files to/from Pelle using the UPPMAX Transit server, using SCP.
The program [`scp`](../../Tools/scp.md) allows you to copy file between Pelle and Transit.
...
???- question "Forgot how to login to Pelle?"
    ...
    See [this step-by-step guide how to login to Pelle](../../../Access/Login/Pelle/index.md).
...
However, [Transit is a service, not a file server](../../Transit/index.md).
