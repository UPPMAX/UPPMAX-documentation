...
[`rsync`](../Tools/rsync.md) is a command-line tool for [file transfer](../index.md).

This page describes how to use [`rsync`](../Tools/rsync.md) on [Pelle](../../../cluster_guides/pelle.md).
