...
[rsync](../Tools/rsync.md) is a tool [to do file transfer to/from Bianca](index.md),
...
To transfer files to/from Bianca using [rsync](../Tools/rsync.md), do the following steps:
...
on how to log in to [Transit](../Transit/index.md).
