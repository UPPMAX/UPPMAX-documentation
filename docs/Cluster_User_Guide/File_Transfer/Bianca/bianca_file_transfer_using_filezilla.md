...
There are multiple ways to [transfer data to/from Bianca](index.md).

Here, we show how to transfer files using a graphical tool called "FileZilla".
See [the UPPMAX page on 'FileZilla'](../Tools/filezilla.md) on how to download and install it.
...
Check how to get inside university networks : [Get inside of SUNET](../../Access/Login/Bianca/get_inside_sunet.md).
...
???- question "How do I know if I am within the university networks?"
    ...
    See [How to get inside of the university networks](../../Access/Login/Bianca/get_inside_sunet.md)
