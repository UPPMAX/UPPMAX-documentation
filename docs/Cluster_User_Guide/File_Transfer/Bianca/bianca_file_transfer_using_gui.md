...
There are
[many ways to transfer files to/from Bianca](index.md).
...
UPPMAX guide                                                                           |Description
---------------------------------------------------------------------------------------|---------------------
[File transfer to/from Bianca using FileZilla](bianca_file_transfer_using_filezilla.md)|All operating systems
[File transfer to/from Bianca using WinSCP](bianca_file_transfer_using_winscp.md)      |Windows-only
