...
[`sftp`](../Tools/sftp.md) is a command-line program
to [transfer files to/from Bianca](index.md).
...
See [the UPPMAX page on `sftp`](../Tools/sftp.md) how to use `sftp` to download and upload files.


Once connected you will have to type the `sftp` commands to upload/download files.
See [the UPPMAX page on `sftp`](../Tools/sftp.md) how to do so.
