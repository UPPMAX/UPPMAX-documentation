...
- Uppsala users of [Rackham](../Extras/glossary.md#rackham) will be moved to Pelle by UPPMAX after [applying to a Pelle project](../getting_started/project_apply_pelle.md).

- Non-Uppsala users of [Rackham](../Extras/glossary.md#rackham) can move their data to Dardel, see [the Rackham to Dardel migration guide](../cluster_guides/dardel_migration.md).
...
we will transfer your data from [Rackham](../Extras/glossary.md#rackham)
