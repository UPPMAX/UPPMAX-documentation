...
See [create and use an SSH key pair for Dardel, step 2](../Extras/NAISS_and_LUMI/Dardel/ssh_key_use_dardel.md#2-how-to-add-an-ssh-key-to-the-pdc-login-portal),
