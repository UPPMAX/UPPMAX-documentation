...
???- "What does that look like?"
    ...
    Here the command is run on a [Rackham](../Extras/glossary.md#rackham)
...
Also, [using the remote desktop via a ThinLinc client](../Cluster_User_Guide/Access/Login/Pelle/login_pelle_remote_desktop_local_thinlinc_client.md) fails.

A solution may be to [use the remote desktop via the web](../Cluster_User_Guide/Access/Login/Pelle/login_pelle_remote_desktop_website.md)
