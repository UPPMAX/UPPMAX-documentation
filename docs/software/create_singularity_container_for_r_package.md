...
???- question "How does that look like?"
    ...
    ** libs
    ...
    gcc -I"/usr/local/lib/R/include" -DNDEBUG -I/usr/local/include  -I/usr/local/include   -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -DPACKAGE_NAME=\"\" -DPACKAGE_TARNAME=\"\" -DPACKAGE_VERSION=\"\" -DPACKAGE_STRING=\"\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_STDLIB_H=1 -DUSE_PTHREADS=1 -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c R_subColSummarise.c -o R_subColSummarise.o
    ...
    qnorm.c:595:63: warning: format ‘%d’ expects argument of type ‘int’, but argument 2 has type ‘sise_t’ {aka ‘long unsigned int’} [-Wformat=]
      ...
      596 |                i, returnCode, *((int *) status));
          |                ~
          |                |
          |                sise_t {aka long unsigned int}
    qnorm.c:616:63: warning: format ‘%d’ expects argument of type ‘int’, but argument 2 has type ‘sise_t’ {aka ‘long unsigned int’} [-Wformat=]
    ...
    qnorm.c:2004:63: warning: format ‘%d’ expects argument of type ‘int’, but argument 2 has type ‘sise_t’ {aka ‘long unsigned int’} [-Wformat=]
    ...
    qnorm.c:2604:63: warning: format ‘%d’ expects argument of type ‘int’, but argument 2 has type ‘sise_t’ {aka ‘long unsigned int’} [-Wformat=]
...
`preprocessCore::colSummariseAvgLog` function:

```r
preprocessCore::colSummariseAvgLog
```
...
???- question "How does that look like?"
    ...
    function (y)
    {
        ...
        .Call("R_colSummarise_avg_log", y, PACKAGE = "preprocessCore")
    }
